    ...
    return (
        <div className="fondo2">
            ...
            <div className="social-icons">
              ...
              <Link to="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Log in with Twitter" className="icon">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
              ...
              <Link to="https://github.com" target="_blank" rel="noopener noreferrer" aria-label="Log in with GitHub" className="icon">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
              ...
              <br />
              <button className="sign" type="submit" href="/AdminFarm" >Ingresar</button>
            </form>
